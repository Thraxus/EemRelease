...
namespace Eem.Thraxus.Extensions
{
    public static class GeneralExtensions
    {
        ...
        public static bool IsHostile(this MyDetectedEntityInfo entityInfo)
        {
            return entityInfo.Relationship == MyRelationsBetweenPlayerAndBlock.Enemies;
        }

        public static bool IsNonFriendly(this MyDetectedEntityInfo entityInfo)
        {
        ...
        public static IMyEntity GetEntity(this MyDetectedEntityInfo entityInfo)
        {
        ...
        /// </summary>
        public static float GetMassT(this MyDetectedEntityInfo entityInfo)
        {
            return entityInfo.GetEntity().Physics.Mass / 1000;
        }

        public static IMyCubeGrid GetGrid(this MyDetectedEntityInfo entityInfo)
        {
            if (!entityInfo.IsGrid()) return null;
            return MyAPIGateway.Entities.GetEntityById(entityInfo.EntityId) as IMyCubeGrid;
        }

        public static bool IsGrid(this MyDetectedEntityInfo entityInfo)
        {
            return entityInfo.Type == MyDetectedEntityType.SmallGrid || entityInfo.Type == MyDetectedEntityType.LargeGrid;
        }
        ...
        public static IMyFaction FindOwnerFactionById(long identityId)
        {
            ...
            foreach (IMyFaction faction in factions)
                if (faction.IsMember(identityId))
                    return faction;
            return null;
        }
