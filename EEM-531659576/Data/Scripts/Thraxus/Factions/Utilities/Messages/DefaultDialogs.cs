...
// Thanks @Kreeg from ARMCO for some submissions to the below!
{
	internal static class DefaultDialogs
	{
		...
		public static readonly Func<string> CatchAll = () => CatchAllMessages.ElementAt(CommonSettings.Random.Next(CatchAllMessages.Count));
        ...
        public static readonly Func<string> CollectiveDisappointment = () => CollectiveDisappointmentMessages.ElementAt(CommonSettings.Random.Next(CollectiveDisappointmentMessages.Count));
	    ...
	    public static readonly Func<string> CollectiveReprieve = () => CollectiveReprieveMessages.ElementAt(CommonSettings.Random.Next(CollectiveReprieveMessages.Count));
	    ...
	    public static readonly Func<string> CollectiveWelcome = () => CollectiveWelcomeMessages.ElementAt(CommonSettings.Random.Next(CollectiveWelcomeMessages.Count));
