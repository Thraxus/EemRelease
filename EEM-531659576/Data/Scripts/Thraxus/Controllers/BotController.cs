...
namespace Eem.Thraxus.Controllers
{
    public class BotController : BaseLoggingClass
    {
        ...
        private void OnEntityAdd(IMyEntity myEntity)
        {
            ...
            var newBot = new BotAi(rc, config, _coordinationController);
