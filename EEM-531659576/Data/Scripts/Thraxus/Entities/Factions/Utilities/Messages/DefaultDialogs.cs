...
// Thanks @Kreeg from ARMCO for some submissions to the below!
{
    internal static class DefaultDialogs
    {
        ...
        public static readonly Func<string> CatchAll = () => CatchAllMessages.ElementAt(Constants.Random.Next(CatchAllMessages.Count));
        ...
        public static readonly Func<string> CollectiveDisappointment = () => CollectiveDisappointmentMessages.ElementAt(Constants.Random.Next(CollectiveDisappointmentMessages.Count));
        ...
        public static readonly Func<string> CollectiveReprieve = () => CollectiveReprieveMessages.ElementAt(Constants.Random.Next(CollectiveReprieveMessages.Count));
        ...
        public static readonly Func<string> CollectiveWelcome = () => CollectiveWelcomeMessages.ElementAt(Constants.Random.Next(CollectiveWelcomeMessages.Count));
